const positions = [
  {
    ...
    points: [
      ...
      'Performed various automations for monotonus/ legacy application that has reduced the manual inputs to 0.',
  ...
  },
  {
    ...
    link: 'http://ncr.com',
    daterange: 'January 2020 - October 2020',
    points: [
      "Designed and developed application that uses DUNS api to catalog customer's hierarchy, used Tree Data structure to perform the same."
      + ' Used Tree data structure to store the hierarchy. Developed using Python and Django.',
  ...
  {
    company: 'Centre of Civil Society',
    position: 'Python/ ML Consultant',
    link: 'https://ccs.in/',
  ...
  },
  {
    ...
    link: 'https://getboarded.tech/',
    daterange: 'June 2018 - January 2019',
    points: [
  ...
  },
  {
    company: 'Technokick',
    position: 'Founder',
    link: 'https://technokick.com',
    daterange: 'June 2014 - January 2021',
    points: [
